...
- Before touching a PR or branch, activate the Dollhouse ensemble `production-code-review-team` and review the diff; review it again after your changes and before commit/PR. Record the pre/post findings and evidence in the PR. CI confirms; it must not discover.
